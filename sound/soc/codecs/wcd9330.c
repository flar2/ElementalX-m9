				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	return 0;
#else
//htc audio ++ disable QCT sense impedance function to avoid kernel panic
...
//htc audio ++
	{"MIC BIAS4 Internal1", NULL, "LDO_H"},
//htc audio --
...
static const struct snd_soc_dapm_widget tomtom_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MICBIAS_E("MIC BIAS4 External", SND_SOC_NOPM, 7,
			       ...
			       SND_SOC_DAPM_POST_PMD),
//htc audio ++
	SND_SOC_DAPM_MICBIAS_E("MIC BIAS4 Internal1", SND_SOC_NOPM, 7,
				   0, tomtom_codec_enable_micbias,
				   SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
				   SND_SOC_DAPM_POST_PMD),
//htc audio --
		...
		struct kobj_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%d %d\n",
		snd_soc_read(sound_control_codec_ptr, TOMTOM_A_CDC_RX3_VOL_CTL_B2_CTL),
		snd_soc_read(sound_control_codec_ptr, TOMTOM_A_CDC_RX5_VOL_CTL_B2_CTL)
	);
}
		...
		struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	snd_soc_write(sound_control_codec_ptr, TOMTOM_A_CDC_RX3_VOL_CTL_B2_CTL, input_l);
	snd_soc_write(sound_control_codec_ptr, TOMTOM_A_CDC_RX5_VOL_CTL_B2_CTL, input_r);
...
#else
	//Set register 0x14a, otherwise MIC2_INP would be always low
	//	0x14a: MBHC_INSERT_DETECT
	//	0x68: PULL_UP_CTRL(bits 7:5): 0x3:I_1370NA
	//	COMPARATOR_VTH(bits 4:3): 0x1: V_0P9_VDD
	// It only happens in wcd9330 but wcd9320
