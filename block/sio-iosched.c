...
/* Tunables */
static const int sync_read_expire  = 80;	/* max time before a sync read is submitted. */
static const int sync_write_expire = 400;	/* max time before a sync write is submitted. */

static const int async_read_expire  = 240;	/* ditto for async, these limits are SOFT! */
static const int async_write_expire = 800;	/* ditto for async, these limits are SOFT! */
