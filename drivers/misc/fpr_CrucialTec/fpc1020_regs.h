...
typedef enum {
	...
	FPC102X_REG_FPC_STATUS			= 20,	
	FPC102X_REG_READ_INTERRUPT		= 24,	
	FPC102X_REG_READ_INTERRUPT_WITH_CLEAR	= 28,	
	FPC102X_REG_READ_ERROR_WITH_CLEAR	= 56,	
	FPC102X_REG_MISO_EDGE_RIS_EN		= 64,	
	FPC102X_REG_FPC_CONFIG			= 68,	
	FPC102X_REG_IMG_SMPL_SETUP		= 76,	
	FPC102X_REG_CLOCK_CONFIG		= 80,	
	FPC102X_REG_IMG_CAPT_SIZE		= 84,	
	FPC102X_REG_IMAGE_SETUP			= 92,	
	FPC102X_REG_ADC_TEST_CTRL		= 96,	
	FPC102X_REG_IMG_RD			= 100,	
	FPC102X_REG_SAMPLE_PX_DLY		= 104,	
	FPC102X_REG_PXL_RST_DLY			= 108,	
	FPC102X_REG_TST_COL_PATTERN_EN		= 120,	
	FPC102X_REG_CLK_BIST_RESULT		= 124,	
	FPC102X_REG_ADC_WEIGHT_SETUP		= 132,	
	FPC102X_REG_ANA_TEST_MUX		= 136,	
	FPC102X_REG_FINGER_DRIVE_CONF		= 140,	
	FPC102X_REG_FINGER_DRIVE_DLY		= 144,	
	FPC102X_REG_OSC_TRIM			= 148,	
	FPC102X_REG_ADC_WEIGHT_TABLE		= 152,	
	FPC102X_REG_ADC_SETUP			= 156,	
	FPC102X_REG_ADC_SHIFT_GAIN		= 160,	
	FPC102X_REG_BIAS_TRIM			= 164,	
	FPC102X_REG_PXL_CTRL			= 168,	
	FPC102X_REG_FPC_DEBUG			= 208,	
	FPC102X_REG_FINGER_PRESENT_STATUS	= 212,	
	FPC102X_REG_HWID			= 252,	
	
	FPC1020_REG_FNGR_DET_THRES		= 216,	
	FPC1020_REG_FNGR_DET_CNTR		= 220,	
	
	FPC1150_REG_OFFSET			= 1000, 
	FPC1150_REG_FNGR_DET_THRES		= 1216,	
	FPC1150_REG_FNGR_DET_CNTR		= 1220,	
