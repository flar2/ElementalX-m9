...
DECLARE_COMPLETION(rmidev_remove_complete_v2_6);
...
exit:
	complete(&rmidev_remove_complete_v2_6);
...
{
	synaptics_rmi4_new_function_v2_6(&rmidev_module, true);
...
{
	synaptics_rmi4_new_function_v2_6(&rmidev_module, false);

	wait_for_completion(&rmidev_remove_complete_v2_6);
