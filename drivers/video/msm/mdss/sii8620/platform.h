...
#define COMPATIBLE_NAME				"mhl-sii8620"

#define MAX_MHL_PCLK 300000
...
#define MHL_TX_DBG_INFO(param, ...) \
{ \
	pr_info("func:%s line:%d " param, __FUNCTION__, __LINE__, ##__VA_ARGS__); \
} \

#define MHL_TX_DBG_WARN(param, ...) \
{ \
	pr_info("func:%s line:%d " param, __FUNCTION__, __LINE__, ##__VA_ARGS__); \
} \

#define MHL_TX_DBG_ERR(param, ...) \
{ \
	pr_err("func:%s line:%d " param, __FUNCTION__, __LINE__, ##__VA_ARGS__); \
} \
...
#define SWITCH_SEL1	20
#define SWITCH_SEL2	21
