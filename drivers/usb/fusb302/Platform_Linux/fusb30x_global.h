...
struct fusb30x_chip                                 // Contains data required by this driver
{
    ...
    FSC_S32 gpio_cc_ovp;			    // HTC SSD USB -- cc ovp pin
    FSC_S32 gpio_aud_control;			    // HTC SSD USB -- audio control pin
    FSC_S32 gpio_in1;				    // HTC SSD USB -- ncn1188 in1
    FSC_S32 gpio_in2;				    // HTC SSD USB -- ncn1188 in2
    FSC_S32 gpio_vconn;				    // HTC SSD USB -- vconn pin
    atomic_t pm_suspended;			    // HTC SSD USB -- pm variable

#ifdef FSC_INTERRUPT_TRIGGERED
    FSC_S32 gpio_IntN_irq;                          // IRQ assigned to INT_N GPIO pin
#endif  // FSC_INTERRUPT_TRIGGERED
    FSC_S32 gpio_cc_ovp_irq;			    // HTC SSD USB -- IRQ assigned to cc ovp pin
...
extern struct fusb30x_chip* fusb_g_chip;
