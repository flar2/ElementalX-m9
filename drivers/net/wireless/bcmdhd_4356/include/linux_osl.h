 ...
 *
 * $Id: linux_osl.h 535133 2015-02-17 08:12:15Z $
 */
...
#define	PKTCHK_STATIC(osh, skb)		osl_pktchk_static((osh), (skb))
#endif
#else
#define	PKTGET_STATIC	PKTGET
#define	PKTFREE_STATIC	PKTFREE
#if defined(MEM_DEBUG)
#define	PKTCHK_STATIC(osh, skb)	BCM_REFERENCE(osh)
#endif
#endif 
...
#if defined(MEM_DEBUG)
extern void osl_pktchk_static(osl_t *osh, void *skb);
#endif
...
#define CONT_ARMREGION	0x02		
#else
#define CONT_MIPREGION	0x00		
#endif 
