...
#define P2P_SEID_SERVICE_HASH		21	
#define P2P_SEID_SESSION		22	
#define P2P_SEID_CONNECT_CAP		23	
#define P2P_SEID_ADVERTISE_ID		24	
#define P2P_SEID_ADVERTISE_SERVICE	25	
#define P2P_SEID_SESSION_ID		26	
#define P2P_SEID_FEATURE_CAP		27	
#define	P2P_SEID_PERSISTENT_GROUP	28	
#define P2P_SEID_SESSION_INFO_RESP	29	
...
BWL_PRE_PACKED_STRUCT struct wifi_p2p_advt_serv_se_s {
	uint8	eltId;			
	uint8	len[2];			
	wifi_p2p_adv_serv_info_t	p_advt_serv_info[1]; 
} BWL_POST_PACKED_STRUCT;
