...
#define D64_XC_MR_MASK		0x000001C0	
...
#define DMA_CTRL_RXSINGLE	(1 << 6)	
#define DMA_CTRL_SDIO_RXGLOM	(1 << 7)	
...
#define	D64_CTRL1_NOTPCIE	((uint32)1 << 18)	
