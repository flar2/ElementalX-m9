...
typedef volatile struct {
	...
	uint32  PAD[20];
	uint32	pmucontrol_ext;		
	uint32	slowclkperiod;		
	uint32	PAD[8];
	uint32	pmuintmask0;		
	uint32	pmuintmask1;		
	uint32  PAD[14];
...
#define OTPP_ROW_MASK9		0x0001ff00		
...
#define JCTRL_TAPSEL_BIT	0x00000008	
...
#define CST43242_SR_CHIP_STATUS_2		27 
...
#define CST43602_SPROM_SIZE                (1<<10) 
#define CST43602_BBPLL_LOCK                (1<<11)
#define CST43602_RF_LDO_OUT_OK             (1<<15) 

#define PMU43602_CC1_GPIO12_OVRD           (1<<28) 

#define PMU43602_CC2_PCIE_CLKREQ_L_WAKE_EN (1<<1)  
#define PMU43602_CC2_PCIE_PERST_L_WAKE_EN  (1<<2)  
#define PMU43602_CC2_ENABLE_L2REFCLKPAD_PWRDWN (1<<3)
#define PMU43602_CC2_PMU_WAKE_ALP_AVAIL_EN (1<<5)  
#define PMU43602_CC2_PERST_L_EXTEND_EN     (1<<9)  
#define PMU43602_CC2_FORCE_EXT_LPO         (1<<19) 
#define PMU43602_CC2_XTAL32_SEL            (1<<30) 
...
#define CST4349_CHIPMODE_SDIOD(cs)	(((cs) & (1 << 6)) != 0)	
#define CST4349_CHIPMODE_PCIE(cs)	(((cs) & (1 << 7)) != 0)	
...
#define CST4345_CHIPMODE_SDIOD(cs)	(((cs) & (1 << 0)) != 0)	
#define CST4345_CHIPMODE_GSPI(cs)	(((cs) & (1 << 1)) != 0)	
#define CST4345_CHIPMODE_HSIC(cs)	(((cs) & (1 << 2)) != 0)	
#define CST4345_CHIPMODE_PCIE(cs)	(((cs) & (1 << 3)) != 0)	
#define CST4345_CHIPMODE_USB20D(cs)	(((cs) & (1 << 18)) != 0)	
...
#define MUXENAB4350_HOSTWAKE_MASK	(0x000000f0)	
...
#define	GCI_CORECTRL_SR_MASK	(1 << 0)	
#define	GCI_CORECTRL_RSL_MASK	(1 << 1)	
#define	GCI_CORECTRL_ES_MASK	(1 << 2)	
#define	GCI_CORECTRL_FSL_MASK	(1 << 3)	
#define	GCI_CORECTRL_SOM_MASK	(7 << 4)	
#define	GCI_CORECTRL_US_MASK	(1 << 7)	
#define	GCI_CORECTRL_BOS_MASK	(1 << 8)	
...
#define GCI_INTSTATUS_RBI	(1 << 0)	
#define GCI_INTSTATUS_UB	(1 << 1)	
#define GCI_INTSTATUS_SPE	(1 << 2)	
#define GCI_INTSTATUS_SFE	(1 << 3)	
#define GCI_INTSTATUS_SRITI	(1 << 9)	
#define GCI_INTSTATUS_STFF	(1 << 10)	
#define GCI_INTSTATUS_STFAE	(1 << 11)	
#define GCI_INTSTATUS_SRFAF	(1 << 12)	
#define GCI_INTSTATUS_SRFNE	(1 << 14)	
#define GCI_INTSTATUS_SRFOF	(1 << 15)	
#define GCI_INTSTATUS_GPIOINT	(1 << 25)	
#define GCI_INTSTATUS_GPIOWAKE	(1 << 26)	

#define GCI_INTMASK_RBI		(1 << 0)	
#define GCI_INTMASK_UB		(1 << 1)	
#define GCI_INTMASK_SPE		(1 << 2)	
#define GCI_INTMASK_SFE		(1 << 3)	
#define GCI_INTMASK_SRITI	(1 << 9)	
#define GCI_INTMASK_STFF	(1 << 10)	
#define GCI_INTMASK_STFAE	(1 << 11)	
#define GCI_INTMASK_SRFAF	(1 << 12)	
#define GCI_INTMASK_SRFNE	(1 << 14)	
#define GCI_INTMASK_SRFOF	(1 << 15)	
#define GCI_INTMASK_GPIOINT	(1 << 25)	
#define GCI_INTMASK_GPIOWAKE	(1 << 26)	

#define GCI_WAKEMASK_RBI	(1 << 0)	
#define GCI_WAKEMASK_UB		(1 << 1)	
#define GCI_WAKEMASK_SPE	(1 << 2)	
#define GCI_WAKEMASK_SFE	(1 << 3)	
#define GCI_WAKE_SRITI		(1 << 9)	
#define GCI_WAKEMASK_STFF	(1 << 10)	
#define GCI_WAKEMASK_STFAE	(1 << 11)	
#define GCI_WAKEMASK_SRFAF	(1 << 12)	
#define GCI_WAKEMASK_SRFNE	(1 << 14)	
#define GCI_WAKEMASK_SRFOF	(1 << 15)	
